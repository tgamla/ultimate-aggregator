(function (factory) {
    ...
    var AggregateFromatter = /** @class */ (function () {
        function AggregateFromatter() {
        }
        AggregateFromatter.getAggrDefinition = function (aggrType, expCode, expObjDef, distinctRef) {
            if (distinctRef === void 0) { distinctRef = ''; }
            return utils.format(AggregateTemplates[aggrType], expCode, expObjDef, distinctRef);
        };
        AggregateFromatter.getPostProcessingAvgDefinition = function (expObjRef) {
            return expObjRef + " = " + expObjRef + ".val / (" + expObjRef + ".count || 1);";
        };
        AggregateFromatter.getPostProcessingConcatDefinition = function (expObjRef, delimiter, sortedValuesObjRef) {
            return "" + sortedValuesObjRef + expObjRef + " = " + expObjRef + ".join(" + delimiter + ");";
        };
        return AggregateFromatter;
    }());
    exports.AggregateFromatter = AggregateFromatter;
